...
if (error) {
console.error(error);
alert("Error saving score. (If you haven’t added unique constraint on player_id+hole, upsert may fail.)");
return;
}
...
const displayNet =
r.holesPlayed === 0 ? "—" : formatToPar(r.netToPar);
const netStyle =
r.holesPlayed === 0
? { opacity: 0.6 }
...
borderSpacing: 0,
minWidth: 520, // forces horizontal scroll on small screens instead of squishing
},
th: {
textAlign: "left",
padding: "10px 10px",
...
/** Phone-friendly tweak: 3 columns -> single column already; make scoreGrid 3 wide on larger screens */
